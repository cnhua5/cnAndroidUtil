...
public class Connection {
    ...
    private NetworkError requestInner(String url, ByteArrayOutputStream bayos) {
        ...
        try {
            ...
            CnLogUtil.printLogInfo("[-Connection-]Make Connect : " + url + "\n" + ((mPostData == null) ? "" : new String(mPostData)));
            ...
            if (statusCode == NetworkError.OK) {
                ...
                if (bayos != null) {
                    ...
                    CnLogUtil.printLogInfo("[-Connection-]Make Connect : " + url + ", Error Result:  " + httpurlconnection.getResponseCode() + ", Response: "
            ...
            try {
                if (errorMsg != null) {
                    errorMsg.put("connectErrorMsg", ExceptionUtil.getErrorInfoFromException(e) + "\n statusCode(" + statusCodeInt + ")");
                }
